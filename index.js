...
/////////////////
const BotName = '< < GAFNA BOT > >'; 
const instagram = 'https://www.instagram.com/ap.gaf_'; 
const telegram = 'KGK ADA:v'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'KGK ADA:v';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@ap.gaf_')
